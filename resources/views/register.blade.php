                            ...
                            <div class="card-body p-3 p-md-4 p-xl-5">
                                ...
                                <form action="{{route('account.processRegister')}}" method="POST">
                                    ...
                                    <div class="row gy-3 overflow-hidden">
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <input type="password" class="form-control @error('password_confirmed') is-invalid @enderror" name="password_confirmed" id="password_confirmed" value="" placeholder="Confirm Password" value="{{old('password_confirmed')}}">
